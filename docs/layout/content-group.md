> [Content grid][content grid] is for displaying grids of items in a responsive format.

[Content grid][content grid] uses flexbox for layout meaning the each element will be aligned to the top of its row.  
