> Exfoliation largely relies on a minimalist aesthetic with ample whitespace. Box styles represent a method to visually reinforce content hierarchy on a grouped set of elements.
